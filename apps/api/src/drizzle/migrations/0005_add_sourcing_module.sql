...
ALTER TABLE "quotations" ALTER COLUMN "estimated_delivery_date" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "quotations" ALTER COLUMN "estimated_delivery_date" TYPE timestamp with time zone USING NULL;--> statement-breakpoint
