...
// Cross-tenant product search (US-61). Joins products → supplier_categories →
// workspaces and applies the active+active+exclude-self filters from the spec.
// Reputation score is intentionally NOT computed here — see ProductSearchService.
@Injectable()
