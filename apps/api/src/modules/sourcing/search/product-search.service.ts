...
export class ProductSearchService {
	...
	// Reputation scores are pre-computed (e.g. via a worker) and stored in Redis
	// under `reputation:{workspaceId}`. We never compute them inline because doing
	// so would blow the 2-3s SLA.
