...
export class RfqService {
	...
	// workspaceId resolves automatically via CLS inside BaseRepository, so we
	// intentionally do not accept it as a parameter here.
	...
	async submitRfq(
		...
		// Notifications fire outside the DB transaction; failures here must not roll
		// back the legal Child RFQ records.
